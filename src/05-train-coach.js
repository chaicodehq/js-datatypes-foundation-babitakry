...
export function findPassenger(passengers, name) {
  ...
  // return passengers.find(passenger => typeof name === "string" && passenger.name.toLowerCase() === name.toLowerCase());
  return passengers.find(function(passenger){
    return typeof name === "string" && passenger.name.toLowerCase() === name.toLowerCase();
  })
}
